    ...
    <>
      ...
      <section className="py-16 md:py-20">
        <div className="container-x grid md:grid-cols-2 gap-12 items-center">
          <div>
            <h3 className="text-[#ec008c] font-bold uppercase text-sm tracking-widest mb-3">Since 2012</h3>
            <h2 className="text-3xl md:text-4xl font-bold text-gray-900 mb-6">A Journey of Compassion and Change</h2>
            <p className="text-gray-600 leading-relaxed mb-4">
              Ganna Sewa Foundation was born from a simple yet powerful belief: every girl child deserves the right to education, health, and a life of dignity. Founded in 2012 by a small group of committed volunteers in Mumbai, we started with just 15 children in a Dharavi community center.
            </p>
            <p className="text-gray-600 leading-relaxed mb-4">
          ...
          <div className="grid md:grid-cols-4 gap-6 mt-10">
            {[
              ...
              <div key={i} className="bg-white rounded-lg p-6 shadow-md text-center hover:shadow-xl transition-shadow">
                <v.Icon className="w-10 h-10 text-[#ec008c] mx-auto mb-4" />
      ...
      <section className="py-16 bg-[#ec008c] text-center text-white">
        <div className="container-x">
          ...
          <Link to="/donate" className="inline-block bg-white text-[#ec008c] px-8 py-3 rounded-full font-bold hover:bg-gray-100 transition-colors">Donate Now</Link>
        </div>
      </section>
    </>
  );
