    ...
    <>
      ...
      <section className="py-16">
        <div className="container-x grid md:grid-cols-3 gap-8">
          ...
          <div className="bg-white rounded-lg p-6 shadow-md border-l-4 border-[#059669]">
            ...
            <a href={`tel:${brand.phoneRaw}`} className="text-gray-700 hover:text-[#059669] text-sm">{brand.phone}</a>
          ...
          <div className="bg-white rounded-lg p-6 shadow-md border-l-4 border-[#059669]">
            ...
            <a href={`mailto:${brand.email}`} className="text-gray-700 hover:text-[#059669] text-sm break-all">{brand.email}</a>
        ...
        <div className="container-x grid md:grid-cols-2 gap-10">
          <div>
            ...
            <form onSubmit={onSubmit} className="space-y-4">
              <input required name="name" value={form.name} onChange={onChange} placeholder="Your Name" className="w-full border border-gray-300 rounded-md px-4 py-3 focus:ring-2 focus:ring-[#059669] focus:border-transparent outline-none bg-white" />
              <input required type="email" name="email" value={form.email} onChange={onChange} placeholder="Your Email" className="w-full border border-gray-300 rounded-md px-4 py-3 focus:ring-2 focus:ring-[#059669] outline-none bg-white" />
              <input required name="subject" value={form.subject} onChange={onChange} placeholder="Subject" className="w-full border border-gray-300 rounded-md px-4 py-3 focus:ring-2 focus:ring-[#059669] outline-none bg-white" />
              <textarea required rows={5} name="message" value={form.message} onChange={onChange} placeholder="Your Message" className="w-full border border-gray-300 rounded-md px-4 py-3 focus:ring-2 focus:ring-[#059669] outline-none bg-white" />
          ...
          <div className="space-y-4">
            ...
            <div className="bg-white rounded-lg p-6 shadow-md flex items-start gap-3">
              <Clock className="w-6 h-6 text-[#059669] flex-shrink-0 mt-0.5" />
              <div>
