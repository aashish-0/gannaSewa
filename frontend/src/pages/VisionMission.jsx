      ...
      <section className="py-16 md:py-20">
        <div className="container-x grid md:grid-cols-2 gap-8">
          <div className="bg-[#faf6f2] rounded-2xl p-10 shadow-sm">
            <div className="w-14 h-14 rounded-full bg-[#ec008c] flex items-center justify-center mb-5">
              <Eye className="w-7 h-7 text-white" />
            </div>
            <h2 className="text-3xl font-bold text-[#ec008c] mb-4">Our Vision</h2>
          ...
          <div className="bg-[#faf6f2] rounded-2xl p-10 shadow-sm">
            ...
            <h2 className="text-3xl font-bold text-[#ec008c] mb-4">Our Mission</h2>
          ...
          <div className="grid md:grid-cols-2 gap-4 mt-8 max-w-4xl mx-auto">
            {values.map((v, i) => (
              <div key={i} className="flex items-start gap-3 bg-[#faf6f2] rounded-lg p-5">
                <CheckCircle2 className="w-6 h-6 text-[#ec008c] flex-shrink-0 mt-0.5" />
