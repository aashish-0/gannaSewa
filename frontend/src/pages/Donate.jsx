...
const UPI_DETAILS = {
  ...
  payeeName: "Ganna Sewa Foundation"
};
        ...
        <div className="container-x max-w-2xl">
          {step === "qr" && (
            <div className="bg-white rounded-xl shadow-lg overflow-hidden">
              {/* Header strip */}
              <div className="bg-gradient-to-r from-[#ec008c] to-[#f062ad] text-white px-8 py-6 text-center">
              ...
              <div className="px-8 pt-10 pb-8 text-center">
                <div className="inline-block bg-white p-4 rounded-lg border-4 border-[#ec008c]/20 shadow-md">
                  <img
                ...
                <div className="mt-4 inline-flex items-center gap-2 bg-[#faf6f2] border border-gray-200 rounded-full px-4 py-2">
                  ...
                  <button
                    onClick={copyUpiId}
                    className="w-7 h-7 rounded-full bg-[#ec008c] hover:bg-[#c70074] transition-colors flex items-center justify-center text-white"
                ...
                <div className="mt-8 text-left bg-[#faf6f2] rounded-lg p-5">
                  ...
                  <ol className="space-y-2 text-sm text-gray-700">
                    <li className="flex gap-3">
                      <span className="flex-shrink-0 w-6 h-6 rounded-full bg-[#ec008c] text-white text-xs font-bold flex items-center justify-center">1</span>
                      Open any UPI app on your phone
                    </li>
                    <li className="flex gap-3">
                      <span className="flex-shrink-0 w-6 h-6 rounded-full bg-[#ec008c] text-white text-xs font-bold flex items-center justify-center">2</span>
                      Tap on &quot;Scan QR&quot; and scan the code above
                    </li>
                    <li className="flex gap-3">
                      <span className="flex-shrink-0 w-6 h-6 rounded-full bg-[#ec008c] text-white text-xs font-bold flex items-center justify-center">3</span>
                      Enter the amount you wish to donate
                    </li>
                    <li className="flex gap-3">
                      <span className="flex-shrink-0 w-6 h-6 rounded-full bg-[#ec008c] text-white text-xs font-bold flex items-center justify-center">4</span>
                      Complete the payment in your UPI app
                    </li>
                    <li className="flex gap-3">
                      <span className="flex-shrink-0 w-6 h-6 rounded-full bg-[#ec008c] text-white text-xs font-bold flex items-center justify-center">5</span>
                ...
                <button
                  onClick={markAsPaid}
                  className="mt-6 w-full inline-flex items-center justify-center gap-2 bg-[#ec008c] hover:bg-[#c70074] transition-colors text-white py-4 rounded-full font-bold text-lg shadow-md"
                >
                ...
                <div className="flex items-center justify-center gap-2 text-xs text-gray-500 mt-4">
                  ...
                  Your donation is 100% secure & goes directly to Ganna Sewa Foundation
                </div>
              </div>
            </div>
          )}
          ...
          {step === "success" && (
            <div className="bg-white rounded-xl shadow-lg overflow-hidden text-center">
              ...
              <div className="px-8 py-10">
                <Heart className="w-10 h-10 text-[#ec008c] fill-[#ec008c] mx-auto mb-4" />
                ...
                <div className="flex flex-col sm:flex-row gap-3 justify-center">
                  <button
                    onClick={() => setStep("qr")}
                    className="bg-white border-2 border-[#ec008c] text-[#ec008c] hover:bg-[#fce4f0] transition-colors px-6 py-2.5 rounded-full font-semibold"
                  >
                    Make Another Donation
                  </button>
                  <a
                    href="/"
                    className="bg-[#ec008c] hover:bg-[#c70074] transition-colors text-white px-6 py-2.5 rounded-full font-semibold"
                  >
                    Back to Home
                  </a>
                </div>
