...
import { celebrities as fallback } from "../data/mock";

const CelebrityPartners = () => {
  const items = useCollection("celebrities", fallback);
      ...
      <div className="container-x">
        ...
        <div className="relative mt-8">
          ...
          <div className="overflow-hidden mx-10">
            <div className="flex transition-transform duration-500 ease-out" style={{ transform: `translateX(-${start * (100 / perView)}%)` }}>
              {items.map((c) => (
