    ...
    <section className="py-16 md:py-20 bg-white">
      <div className="container-x">
                ...
                <div key={s.id} className="flex-shrink-0 w-full md:w-1/2 lg:w-1/3 px-3">
                  <div className="bg-white rounded-lg shadow-md overflow-hidden h-full flex flex-col group">
                    ...
                    <div className="p-6 flex-1 flex flex-col">
                      <h3 className="text-xl font-bold text-gray-900 mb-3 group-hover:text-[#ec008c] transition-colors">
                        {s.title}
                      </h3>
        ...
        <div className="flex justify-center mt-10">
          <a
            href="#"
            className="bg-[#ec008c] hover:bg-[#c70074] transition-colors text-white px-7 py-2.5 rounded-full font-semibold shadow-md"
          >
            View More
          </a>
        </div>
